...
# Figure 4. Heatmap for cultivars and V. amurensis (ITS)
Heatmap = upset_data
...
Heatmap_percent[Heatmap_percent[] == scales::percent(10000, scale = 1, accuracy = 0.1)] <- "<0.10%"

png("Figure 4. Heatmap for cultivars and V. amurensis (ITS).png",  width = 17, height = 10, units = "in", res = 300)
