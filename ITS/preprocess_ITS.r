...
sampledata_meta = read.table(file="./Metagenome metadata/sampledata_its_meta.txt", row.names = 2, header = TRUE, colClasses = "character", sep="\t") # Sample metadata for the metagenome
...
save(physeq, physeq_organ, physeq_read_counts_organ, physeq_for_div, V_amur, cultivars, V_amur_organ, cultivars_organ, physeq_for_beta, physeq_for_alfa, physeq_main, sampledata_meta_2, physeq_read_counts, dir,  file = "./ITS/physeq.RData")

save(physeq_its, file = "./ITS/physeq_its_for_network.RData")