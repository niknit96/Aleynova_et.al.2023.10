...
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="Supporting information 4. Intersections in ITS metagenome data of cultivars and V. amurensis plant samples.txt")
#
...
# Figure 3b. Upset diagram for V. amurensis plants (16s)
png("Figure 3b. Upset diagram for cultivars and V. amurensis plants (ITS).png",  width = 13, height = 8, units = "in", res = 300)
