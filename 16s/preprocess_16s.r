...
save(physeq, physeq_for_div, V_amur, cultivars, physeq_for_beta, physeq_for_alfa, physeq_main, sampledata_meta_2, physeq_read_counts, dir,  file = "./16s/physeq.RData")