...
# Figure 5b. NMDS ordination plot of Vitis communities (16s)
...
ggsave("Figure 5b. NMDS ordination plot of Vitis communities (16s).png", width = 14, height = 9)
#
...
write.table(as.data.frame(beta_Plant), sep = "\t", quote = FALSE, file="Supporting information Table S5. PERMANOVA results (16s data).txt")
